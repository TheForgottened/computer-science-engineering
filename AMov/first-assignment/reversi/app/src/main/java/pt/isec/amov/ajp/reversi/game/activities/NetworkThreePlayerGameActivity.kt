...
import pt.isec.amov.ajp.reversi.databinding.ActivityThreePlayerGameBinding
import pt.isec.amov.ajp.reversi.game.GameModel
import pt.isec.amov.ajp.reversi.game.NetworkGameViewModel
import pt.isec.amov.ajp.reversi.game.NetworkRecyclerViewAdapter
import pt.isec.amov.ajp.reversi.game.TypePiece

class NetworkThreePlayerGameActivity : AppCompatActivity() {
    private lateinit var binding : ActivityThreePlayerGameBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityThreePlayerGameBinding.inflate(layoutInflater)
        ...
        binding.imageViewAvatarThree?.setBackgroundColor(getColor(R.color.dracula_purple))
        ...
        if (GameModel.players[2].avatar != null) {
            binding.imageViewAvatarThree?.setImageBitmap(GameModel.players[2].avatar)
        }
    ...
    fun updateView() {
        ...
        binding.nameThree?.text = GameModel.players[2].name
        ...
        binding.nameThree?.setTextColor(this.getColor(R.color.dracula_foreground))
        ...
        when (GameModel.currentPlayer.value) {
            ...
            2 -> binding.nameThree?.setTextColor(this.getColor(R.color.dracula_green))
        }
    }
