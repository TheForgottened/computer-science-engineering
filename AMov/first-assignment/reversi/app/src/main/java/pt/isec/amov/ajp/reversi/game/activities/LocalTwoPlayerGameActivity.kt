...
import pt.isec.amov.ajp.reversi.game.GameViewModel
import pt.isec.amov.ajp.reversi.game.RecyclerViewAdapter
import pt.isec.amov.ajp.reversi.game.TypePiece

class LocalTwoPlayerGameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.gameModel.isOnline = false
        ...
        if (ReversiLocalReader.hasAvatar()) {
            ...
            binding.imageViewAvatarOne?.setImageBitmap(bitmap)
        }
