...
int main( int argc , char *argv[] )
{
	...
	SOCKET sockfd;
	int msg_len, iResult, nbytes, cli_len, serv_check_len, resposta;
	...
	switch(result)
	{
		...
		default:
			...
			{	
				nbytes=recvfrom(sockfd , (char *)&resposta , sizeof(resposta) , 0 , (struct sockaddr*) &serv_check , &serv_check_len);
