...
public class JPrivateMessagePanel extends JPanel {
    private final TinyUser messageReceiver;
    private final JFrame parentFrame;
    private final MetaPdObservable metaPdObservable;

    private File selectedFile = null;

    public JPrivateMessagePanel(TinyUser messageReceiver, JFrame parentFrame, MetaPdObservable metaPdObservable) {
    ...
    private void stylizeWindow() {
        ...
        JLabel messageTitleLabel = new JLabel("Message to " + messageReceiver.username());
