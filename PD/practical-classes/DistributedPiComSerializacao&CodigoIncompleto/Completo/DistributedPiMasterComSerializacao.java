                ...
                try {                    
                    ...
                    if(elapsedTime > TABLE_ENTRY_TIMEOUT){
                        ...
                        try(Statement stmt2 = conn.createStatement()){
                            stmt2.executeUpdate("DELETE FROM pi_workers WHERE address = '" + workerName + "' AND port = " + workerPort + ";"); //Se usarmos stmt, rs é encerrado, o que resulta numa excepcao no while 
                        }
                        continue;
                    }
