...
turtles-own [energia] ; Todos os agentes têm energia
ants-own [nErva] ; As formigas podem carregar comida
      ...
      ifelse [pcolor] of patch-ahead 1 = red
        ...
        [ifelse [pcolor] of patch-ahead 1 = blue
          [fd 1 ;; � frente � ninho, avan�a e desaparece
           set blue-nest blue-nest + 1  ;;Passo 3
           die]
           [ifelse random 100 < 90 ;; � frente � preta
              [fd 1]   ;; avan�a com 90%
              [ifelse random 100 < 5
    ...
    ask snails[
      ...
      [ifelse [pcolor] of patch-left-and-ahead 90 1 = yellow[
          ...
          [ifelse [pcolor] of patch-right-and-ahead 90 1 = yellow[
              rt 90 fd 1 set yellow-nest yellow-nest + 1 die]
              [ifelse [pcolor] of patch-ahead 1 = red[
                  rt 90]
                  [ifelse [pcolor] of patch-left-and-ahead 90 1 = red[
                      ...
                      [ifelse [pcolor] of patch-right-and-ahead 90 1 = red
                        ...
                        [ifelse random 100 < 90
                          [forward 1]
                          [ifelse random 100 < 5 [rt 90][lt 90]
                          ]
                        ]
                      ]
                  ]
...
to mimetism
ask ants[
  ifelse any? snails-on neighbors
    [set color yellow]
    [set color blue]
]
end
...
to reproduction
  ...
  ask snails [
    if energia > birthEnergy [
      if random 101 < reproductionSnails [
        set energia round(energia / 2)
